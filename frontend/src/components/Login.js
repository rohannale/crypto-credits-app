...
const Login = ({ onToggleView, onBackToHome }) => {
        ...
        <div className="max-w-md text-center">
          <div className="mb-8">
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              Your digital fortune awaits. Sign in to continue your journey toward universal good luck.
            </p>
          </div>

          <div className="bg-karma-lime/5 border border-karma-lime/20 rounded-xl p-6">
            <h3 className="text-karma-lime font-semibold mb-3">Why Karma Works</h3>
            <ul className="text-gray-300 text-sm space-y-2">
              <li className="flex items-center">
                <span className="text-karma-success mr-2">•</span>
                Digital tokens for good fortune
              </li>
              <li className="flex items-center">
                <span className="text-karma-success mr-2">•</span>
                Blockchain-powered luck
              </li>
              <li className="flex items-center">
                <span className="text-karma-success mr-2">•</span>
